...
public class ObtenerUsuarioService implements ObtenerUsuarioUseCase{
    ...
    public ObtenerUsuarioService(UserRepositoryPort usuarioRepositoryPort){
        this.usuarioRepositoryPort = usuarioRepositoryPort;
    }

    @Override
    public User buscarUsuario(Integer idUser) {

        User usuario = usuarioRepositoryPort.consultar(idUser)
